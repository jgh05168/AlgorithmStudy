...
- 이동하려는 칸이 파랑색인 경우, 우선 방향을 반대로 바꾸고, 한 칸 이동한다.
    - 가장 아래 말을 기준으로 설정할 것
    - 방향을 돌려 이동하려 하는데 이동이 불가능한 경우라면, 가만히있기
- 빨간색인 경우, 이동 후 reverse
    - reverse 할 때 dictionary 정보도 변경해주어야 한다.
- 올라가있는지에 대한 정보를 딕셔너리로 표현

[출처]
https://velog.io/@yoonuk/%EB%B0%B1%EC%A4%80-17780-%EC%83%88%EB%A1%9C%EC%9A%B4-%EA%B2%8C%EC%9E%84-Python
'''
import sys
